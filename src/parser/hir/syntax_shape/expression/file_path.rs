use crate::parser::hir::syntax_shape::{
    expand_syntax, expand_variable, expression::expand_file_path, parse_single_node, BarePathShape,
    ExpandContext, ExpandExpression, ExpandSyntax,
};
use crate::parser::{hir, hir::TokensIterator, RawToken, Token, TokenNode};
use crate::prelude::*;
